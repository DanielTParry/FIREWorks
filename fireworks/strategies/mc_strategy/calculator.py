...
class MCSimulator:
    ...
    def __init__(self, mean_model, variance_model, consumption_model):
        """
        Initialize the simulator.

        Args:
            mean_model: MeanModel instance defining μ(t)
            variance_model: VarianceModel instance defining v(t)
